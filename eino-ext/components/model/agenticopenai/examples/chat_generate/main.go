...
func main() {
	...
	msg, err := m.Generate(ctx, firstInput, model.WithTools(functionTools))
	if err != nil {
	...
	lastBlock := msg.ContentBlocks[len(msg.ContentBlocks)-1]
	...
	secondInput := append(firstInput, msg, toolResultMsg)
