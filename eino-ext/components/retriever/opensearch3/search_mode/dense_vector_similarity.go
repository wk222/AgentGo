...
func DenseVectorSimilarity(typ DenseVectorSimilarityType, vectorFieldName string) opensearch3.SearchMode {
...
func (d *denseVectorSimilarity) BuildRequest(ctx context.Context, conf *opensearch3.RetrieverConfig, query string,
	...
	// https://opensearch3.org/docs/latest/query-dsl/specialized/script-score/
