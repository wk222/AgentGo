...
func SearchModeSparseVectorTextExpansion(modelID, vectorFieldName string) es9.SearchMode {
...
func (s sparseVectorTextExpansion) BuildRequest(ctx context.Context, conf *es9.RetrieverConfig, query string,
