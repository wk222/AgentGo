module github.com/cloudwego/eino-ext/acp/examples

go 1.24

replace github.com/cloudwego/eino-ext/acp => ../

require (
	github.com/cloudwego/eino v0.8.11
	github.com/cloudwego/eino-ext/acp v0.0.0-00010101000000-000000000000
